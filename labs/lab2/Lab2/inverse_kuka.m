...
Oc = Od - Rd*[myrobot.a(6);0;myrobot.d(6)]; %Compute position of wrist center for KUKA arm


q(1) = atan2(Oc(2),Oc(1));
as = real(sqrt(myrobot.a(3)^2+myrobot.d(4)^2));

D = ((Oc(3)-myrobot.d(1))^2+(real(sqrt(Oc(1)^2+Oc(2)^2))-myrobot.a(1))^2-myrobot.a(2)^2-as^2)/(2*myrobot.a(2)*as); 
q(3) = atan2(D,real(sqrt(1-D^2))); %compute angle for joint 2 from frame 0 to frame 1
q(2) = atan2(Oc(3)-myrobot.d(1), real(sqrt(Oc(1)^2+Oc(2)^2))-myrobot.a(1))-atan2(as*sin(q(3)-pi/2),myrobot.a(2)+as*cos(q(3)-pi/2));%compute angle for joint 3 from frame 0 to frame 1
q(3) = q(3)-atan2(myrobot.a(3),myrobot.d(4));
